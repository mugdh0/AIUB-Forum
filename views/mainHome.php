...
<nav class="navStyle">
	...
	<ul>
        ...
        if (!isset($_GET['$a'])) {
            $_SESSION['id']='';
            echo "<li style='margin-left: 500px;'><a href='../views/login.php'>login</a></li>";
	  ...
	  transition: all 0.3s ease;">
            ...
            if (!isset($_GET['$a'])) {
                ...
                while ($row=$result->fetch_assoc()) {
                    ...
                    echo "<br>";
                    echo "Position: ".$row['designation'];
                    echo "<button style='margin-left:70px;'onclick='showProfile()' type='submit' name='b' >close</button>";
                }
            }
